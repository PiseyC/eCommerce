...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($role->save()){
            ...
            $notification = array('alert-type' => 'success', 'message' => 'Successfully created the new '. $role->display_name . ' role in the database.');
            return redirect()->route('roles.show', $role->id)->with($notification);
        }else{
            $notification = array('message' => 'Sorry a problem occurred while requesting','alert-type' => 'error');
    ...
    public function update(Request $request, $id)
    {
        ...
        if($role->save()){
            ...
            \LogActivity::addToLog($request->display_name);
            $notification = array('alert-type' => 'success', 'message' => 'The '. $role->display_name . ' role is successfully updated.');
            return redirect()->route('roles.show', $id)->with($notification);
        }else{
            $notification = array('message' => 'Sorry a problem occurred while requesting','alert-type' => 'error');
